...
{
    public:
    void populate(int a, int b, vector<vector<int>> &initPop, vector<vector<char>> map, vector<vector<int>> &tempVec, int &tempWork)
    {
        
        if(initPop[a][b] == 0 && pLine(a,b,map) == true)   
        {
            tempVec[a][b]++;
            tempWork++;
        }
        else if(initPop[a][b]==0 && adjPop(a,b,initPop,1,1) == true)
        {
            
            tempVec[a][b]++;
            tempWork++;
        }
        else if(initPop[a][b]==1 && adjPop(a,b,initPop,1,2) == true)
        {
            tempVec[a][b]++;
            tempWork++;
        }
        else if(initPop[a][b]==2 && adjPop(a,b,initPop,2,4) == true)
        {
            tempVec[a][b]++;
            tempWork++;
        }
        else if(initPop[a][b]==3 && adjPop(a,b,initPop,3,6) == true)
        {
            tempVec[a][b]++;
            tempWork++;
        }
        else if(initPop[a][b]==4 && adjPop(a,b,initPop,4,8) == true)
        {
            tempVec[a][b]++;
            tempWork++;
        }
